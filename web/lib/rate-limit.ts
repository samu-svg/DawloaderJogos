...
export const RATE_LIMITS = {
  ...
  /** Pedido de e-mail de recuperação: curto por IP. */
  authMail: { limit: 5, window: "15 m" as Window },
  /** Pedido de e-mail de recuperação: por endereço. */
  authMailSlow: { limit: 3, window: "1 h" as Window },
